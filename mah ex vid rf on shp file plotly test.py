...
'VETALE_KHED','WADGAONSHERI_PUNE','WALHE_PURANDAR','SHIRALA','TASGAON','PANHALA',
'GANGAPUR','KANNAD','BHOKARDAN',
'GHANSANGAVI','PARTUR']
...
'BHAYANDER','MIRA_ROAD','IIGHQ_NEWPANVEL','KARJAT','IIG_MO_ALIBAG','MATHERAN','BHIRA','POLADPUR','INS_SHIVAJI_LONAVALA','TALEGAON','GIRIVAN','CHINCHWAD_PUNE','MTI_PASHAN_PUNE','CME_DAPODI','RJSPMCOP_DUDULGAON','LAVALE','SHIVAJINAGAR_PUNE','PASHAN_AWS_LAB','RAJGURUNAGAR','BLINDSCHOOL_KP_PUNE','NDA_PUNE','MAGARPATTA_PUNE','WADGAONSHERI_PUNE','VETALE_KHED','DPS_HADAPSAR_PUNE','LONIKALBHOR_HAVELI','PABAL_SHIRUR','BALLALWADI_JUNNAR','KHADAKWADI_AMBEGAON','NIMGIRI_JUNNAR','TALEGAON_DHAMDHERE','NARAYANGOAN_KRISHI_KENDRA','CHRIST_UNIVERSITY_LAVASA','CAGMO_SHIVAJINAGAR','KHUTBAV_DAUND','WALHE_PURANDAR','MALIN_AMBEGAON','GUDHE_BHOR','NIASM_BARAMATI','NES_LAKADI_INDAPUR','PARNER','KOPERGAON','SHRIGONDA',
...
'POWARWADI(BHAMBHED)','CHIPLUN','RATNAGIRI','RATNAGIRI_AWS400','MAHABALESHWAR','SATARA','BGRL_KARAD','MOHOL_KVK','SOLAPUR','SANGOLA_MAHAVIDYALAYA','KOLHAPUR_AMFU','PANHALA','RADHANAGRI_ARS','GANGAPUR','AURANGABAD_KVK','AURANGABAD','KANNAD','CHALISGAON','CHOPDA','JALGAON','JAMNER','DHULE','SHIRALA','TASGAON','SANGLI_KVK','AKKALKUWA','NAVAPUR','NANDURBAR_KVK','SHAHADA_AWS400','JALNA','BHOKARDAN','GHANSANGAVI','PARTUR','VAIBHAVWADI','AWALEGAON','MULDE_AMFU','DEVGAD',
'VENGURLA','OSMANABAD','TULGA_KVK','AMBEJOGAI','BEED_PTO','LATUR','UDGIR_AWS400','HINGOLI','TONDAPUR_AWS400','PARBHANI_AMFU','NANDED','SAGROLI_KVK'
]
print(len(all_mh))
...
df_rev = {
    'STATIONS': ['MURUD','NANDURBAR','BHANDARDARA','PAITHAN',
'PARALIVAIJANATH','SHIRPUR','SHIRUR','AUNDHA_NAGNATH','KALAMNURI','SHAHUWADI','CHAKUR','NILANGA','GARGOTI(BHUDARGAD)','BHOKAR','TALODA','KALAMB','PURNA','SONPETH','PANCHGANI','UMADI','AKKALKOT','KARMALA','PHALTAN'],

    'Column2': ['A', 'B', 'C', 'D']
}

df = pd.DataFrame(df_rev)
