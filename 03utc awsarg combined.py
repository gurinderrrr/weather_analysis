...
df_rf_leg_mh=pd.DataFrame({'':['Not Reported','0.0 (No Rain)','upto 2.5 (Very Light Rain)/\nMin Temp','2.6 - 15.5 (Light Rain)','15.6 - 64.5 (Moderate Rain)','64.6 - 115.5 (Heavy Rain)','115.6 - 204.5 (Very Heavy Rain)','>204.5 (Extremely Heavy Rain)/\nMax Temp','Error Values']})
df_rf_leg_col_mh=pd.DataFrame({'':['','','Min Temp','','','','','Max Temp','Error Value']})
awsarg_df_sum_data_mh= pd.DataFrame([["Total AWS/AGRO stations"],['Total AWS/AGRO stations reporting'],['Total ARG stations'],['Total ARG stations reporting']])
...
l=13+len(awsarg_df_sum_data_mh)+1
